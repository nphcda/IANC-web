...
const DashboardNavbar = () => {
    ...
    const { staffname } = healthfacilityAuth?.others;
    ...
    return (
        <div className='h-[90px] flex items-center justify-between px-2 bg-white'>
            ...
            <div className='flex flex-row gap-2 items-center'>
                ...
                <div className='rounded-full flex items-center text-[16px] font-[500] justify-center bg-[#F3722C] text-light10 w-[40px] h-[40px]'>
