          ...
          >
            ...
            <div className="">
              ...
              <div className="flex gap-6 mt-4">
                ...
                <button
                  onClick={logout}
                  className="text-white bg-[#7A6EFE] min-w-[100px] p-2 font-[500]"
                >
                  Confirm
                </button>
              </div>
      ...
      {!loaderFinished ? (
        ...
        >
          <div className="absolute w-screen z-50">
            ...
            >
              <BsFillArrowUpCircleFill className="text-[#7A6EFE] text-[30px]" />
            </div>
          </div>
          <div
            id="menu"
              ...
              <div className="absolute z-50 top-0 left-0">
                {showmenu ? (
                  <BsFillArrowLeftSquareFill
                    ...
                    className="text-[#7A6EFE] cursor-pointer text-[20px] "
                  />
                ) : (
                  <BsFillArrowRightSquareFill
