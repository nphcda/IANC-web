...
const Accounts = () => {
  ...
  switch (navigatorSlide) {
    ...
    case 2:
      ...
      break;
    case 3:
      componentToRender = <CreateStateUserAccount />;
      break;
    case 4:
    ...
    <div className="">
      <div className="bg-primary10  w-full">
        ...
        <div className="w-full flex items-center justify-center font-inter my-5">
          <div className="bg-white min-w-[1000px] m-4 flex flex-col items-center justify-start px-3 py-4">
            {/* navigator */}
            <div className="flex items-center justify-evenly w-full gap-4">
              ...
              >
                Create Health Facility User Account{" "}
              </div>
              <div
