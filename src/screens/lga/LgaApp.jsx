                ...
                <motion.div initial={{
                    ...
                    <div className="">
                        ...
                        <div className="flex gap-6 mt-4">
                            ...
                            <button onClick={logout} className='text-white bg-[#842029] min-w-[100px] p-2 font-[500]'>Confirm</button>
                        </div>
                ...
                <div className={`flex w-full ${confirmlogout && "overflow-hidden"} relative`}>
                    <div className="absolute w-screen z-50">
                        <div onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="fixed right-8 bottom-8 cursor-pointer animate-bounce">
                            <BsFillArrowUpCircleFill className="text-[#842029] text-[30px]" />
                        </div>
                    </div>
                    ...
                    <div id="page" className="flex-[4] bg-[#f8f9fa]">
                        ...
                        <div className="relative">
                            <div className="absolute z-50 top-0 left-0">
                                {showmenu ? <BsFillArrowLeftSquareFill onClick={() => setShowmenu(false)} className="text-[#842029] cursor-pointer text-[20px] " /> :
                                    <BsFillArrowRightSquareFill onClick={() => setShowmenu(true)} className="text-[#842029] cursor-pointer text-[20px]" />}
                            </div>
                            <Routes>
