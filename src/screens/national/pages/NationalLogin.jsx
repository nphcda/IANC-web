          ...
          <div className="absolute top-0 inset-0">
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <div className="text-center text-[24px] font-popp font-[500] tracking-[0.24px] text-primary10">
                Please enter details to sign in to National
              </div>
              <form onSubmit={handleForm} className="flex flex-col gap-4 mt-4">
                ...
                <div>
                  <Link
                    to="/national/forgotpassword"
                    className="text-[16px] hover:text-primary70 cursor-pointer text-right font-[500] text-[#fff]"
                  >
                    <p>forgot Password?</p>
                  </Link>
                </div>
